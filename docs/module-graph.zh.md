...
flowchart TD
  ...
  subgraph group_guard["packages/guard"]
    pkg_budget_governor["budget-governor"]
  ...
  subgraph group_lsp["packages/lsp"]
    ...
    pkg_lsp_typescript_inprocess["lsp-typescript-inprocess"]
  ...
  pkg_llm_deepseek --> pkg_output_retention
  ...
  pkg_web_fetch_http --> pkg_output_retention
  ...
  pkg_lsp_typescript_inprocess --> pkg_invariants
  pkg_lsp_typescript_inprocess --> pkg_lsp
  ...
  pkg_session_retention --> pkg_invariants
  pkg_session_retention --> pkg_session
  ...
  pkg_session_persistence --> pkg_session_retention
  ...
  pkg_goal_round_driver --> pkg_output_retention
  ...
  pkg_session_persistence_jsonl --> pkg_session_retention
  ...
  pkg_session_persistence_sqlite --> pkg_session_retention
  ...
  pkg_tool_fs --> pkg_llm
  pkg_tool_fs --> pkg_output_retention
  ...
  pkg_subagent --> pkg_output_retention
  ...
  pkg_tool_web --> pkg_output_retention
  ...
  pkg_plugin_diagnostic_sifter --> pkg_output_retention
  pkg_plugin_diagnostic_sifter --> pkg_subprocess
  pkg_plugin_diagnostic_sifter --> pkg_tools
  pkg_plugin_doc_sync_automator --> pkg_invariants
  pkg_plugin_doc_sync_automator --> pkg_tools
  pkg_plugin_impacted_tests --> pkg_invariants
  ...
  pkg_plugin_semantic_patcher --> pkg_atomic_write
  pkg_plugin_semantic_patcher --> pkg_invariants
  pkg_plugin_semantic_patcher --> pkg_tools
  ...
  pkg_plugin_worktree_sandbox --> pkg_tools
  ...
  pkg_budget_governor --> pkg_agent
  pkg_budget_governor --> pkg_invariants
  pkg_budget_governor --> pkg_llm
  pkg_budget_governor --> pkg_session
  pkg_budget_governor --> pkg_subagent
  pkg_budget_governor --> pkg_token_meter
  pkg_host_apiproxy --> pkg_agent_presets
  pkg_host_apiproxy --> pkg_cordis_host_runner
  pkg_host_apiproxy --> pkg_invariants
  pkg_plugin_subagent_router --> pkg_agent
  pkg_plugin_subagent_router --> pkg_invariants
...
| [`web-fetch-http`](../packages/web/web-fetch-http) | `web` | [`invariants`](../packages/runtime-diagnostics/invariants), [`output-retention`](../packages/util/output-retention), [`timeout`](../packages/util/timeout), [`web`](../packages/web/web) |
...
| [`lsp-typescript-inprocess`](../packages/lsp/lsp-typescript-inprocess) | `lsp` | [`invariants`](../packages/runtime-diagnostics/invariants), [`lsp`](../packages/lsp/lsp) |
...
| [`session-retention`](../packages/session/session-retention) | `session` | [`invariants`](../packages/runtime-diagnostics/invariants), [`session`](../packages/core/session) |
...
| [`spill-local`](../packages/spill/spill-local) | `spill` | [`invariants`](../packages/runtime-diagnostics/invariants), [`session-retention`](../packages/session/session-retention), [`spill`](../packages/spill/spill) |
| [`attachment-local`](../packages/attachment/attachment-local) | `attachment` | [`attachment`](../packages/attachment/attachment), [`home-paths`](../packages/util/home-paths), [`invariants`](../packages/runtime-diagnostics/invariants), [`session-retention`](../packages/session/session-retention) |
...
| [`session-persistence`](../packages/session/session-persistence) | `session` | [`brand`](../packages/util/brand), [`invariants`](../packages/runtime-diagnostics/invariants), [`session`](../packages/core/session), [`session-retention`](../packages/session/session-retention), [`timeout`](../packages/util/timeout) |
...
| [`goal-round-driver`](../packages/goal/goal-round-driver) | `goal` | [`agent`](../packages/core/agent), [`goal`](../packages/goal/goal), [`invariants`](../packages/runtime-diagnostics/invariants), [`llm`](../packages/llm/llm), [`output-retention`](../packages/util/output-retention), [`session`](../packages/core/session) |
...
| [`session-persistence-jsonl`](../packages/session/session-persistence-jsonl) | `session` | [`invariants`](../packages/runtime-diagnostics/invariants), [`session`](../packages/core/session), [`session-persistence`](../packages/session/session-persistence), [`session-retention`](../packages/session/session-retention) |
| [`session-persistence-sqlite`](../packages/session/session-persistence-sqlite) | `session` | [`invariants`](../packages/runtime-diagnostics/invariants), [`session`](../packages/core/session), [`session-persistence`](../packages/session/session-persistence), [`session-retention`](../packages/session/session-retention) |
...
| [`tool-fs`](../packages/fs/tool-fs) | `fs` | [`attachment`](../packages/attachment/attachment), [`fs`](../packages/fs/fs), [`invariants`](../packages/runtime-diagnostics/invariants), [`llm`](../packages/llm/llm), [`output-retention`](../packages/util/output-retention), [`sandbox`](../packages/sandbox/sandbox), [`sandbox-policy`](../packages/sandbox/sandbox-policy), [`session`](../packages/core/session), [`system-prompt`](../packages/core/system-prompt), [`tools`](../packages/core/tools), [`user-approval`](../packages/interaction/user-approval) |
...
| [`subagent`](../packages/subagent/subagent) | `subagent` | [`agent`](../packages/core/agent), [`agent-presets`](../packages/preset/agent-presets), [`brand`](../packages/util/brand), [`invariants`](../packages/runtime-diagnostics/invariants), [`jobs`](../packages/jobs/jobs), [`llm`](../packages/llm/llm), [`output-retention`](../packages/util/output-retention), [`sandbox`](../packages/sandbox/sandbox), [`sandbox-policy`](../packages/sandbox/sandbox-policy), [`scope`](../packages/core/scope), [`session`](../packages/core/session), [`session-persistence`](../packages/session/session-persistence), [`session-projection`](../packages/session/session-projection), [`session-projection-cache`](../packages/session/session-projection-cache), [`tools`](../packages/core/tools), [`user-approval`](../packages/interaction/user-approval) |
| [`tool-web`](../packages/web/tool-web) | `web` | [`invariants`](../packages/runtime-diagnostics/invariants), [`llm`](../packages/llm/llm), [`output-retention`](../packages/util/output-retention), [`system-prompt`](../packages/core/system-prompt), [`tools`](../packages/core/tools), [`web`](../packages/web/web) |
