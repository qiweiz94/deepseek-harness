...
依赖：`subagents` · `agents` · `tokenMeter`
...
来源：[`packages/compaction/compaction-basic/src/types.ts:42`](../packages/compaction/compaction-basic/src/types.ts)
...
来源：[`packages/lsp/lsp-typescript-inprocess/src/index.ts:30`](../packages/lsp/lsp-typescript-inprocess/src/index.ts)
...
来源：[`packages/plugins/plugin-arch-guard/src/index.ts:21`](../packages/plugins/plugin-arch-guard/src/index.ts)
...
来源：[`packages/plugins/plugin-semantic-patcher/src/index.ts:22`](../packages/plugins/plugin-semantic-patcher/src/index.ts)
...
来源：[`packages/plugins/plugin-subagent-router/src/index.ts:42`](../packages/plugins/plugin-subagent-router/src/index.ts)
...
来源：[`packages/plugins/plugin-telemetry-recorder/src/index.ts:29`](../packages/plugins/plugin-telemetry-recorder/src/index.ts)
...
来源：[`packages/session/session-persistence-sqlite/src/index.ts:71`](../packages/session/session-persistence-sqlite/src/index.ts)
...
来源：[`packages/spill/spill-local/src/index.ts:28`](../packages/spill/spill-local/src/index.ts)
...
来源：[`packages/shell/tool-bash-persistent/src/index.ts:406`](../packages/shell/tool-bash-persistent/src/index.ts)
...
- `@deepseek-ai/dsh-session-retention` ([`packages/session/session-retention/src/index.ts`](../packages/session/session-retention/src/index.ts))
