  ...
  },
  {
    ...
    methods: [
      ...
      },
      {
        ...
        description: 'Register a namespace schema and receive its owner scope. The registration is an effect on the calling plugin\'s fiber: disposing that fiber removes the namespace and its observers, and waits until every started watcher invocation settled so no callback outlives the fiber. An invalid stored section fails the registration itself — the earliest point where the schema can judge it.',
