...
describe('gen-tool-catalog collectToolCatalog', () => {
  it('boots every shipped tool package and harvests its model-facing schemas', async () => {
    ...
    expect(names).toEqual(['ask_user_question', 'bash', 'bash', 'check_module_boundary', 'cordis_define', 'cordis_inspect_list', 'cordis_inspect_query', 'cordis_inspect_self', 'cordis_run', 'cordis_stop', 'cordis_undefine', 'create_goal', 'edit', 'exit_plan_mode', 'find_references', 'get_definition', 'get_directory_outline', 'get_file_outline', 'get_goal', 'get_session_telemetry', 'glob', 'grep', 'interrupt_agent', 'job_kill', 'job_list', 'job_output', 'list_agents', 'lsp', 'patch_symbol_body', 'pwsh', 'ralph', 'read', 'read_image', 'report', 'run_code', 'run_diagnostic_check', 'run_impacted_tests', 'sandbox_exec', 'schedule_create', 'schedule_delete', 'schedule_list', 'scratchpad_update', 'send_message', 'session_event_read', 'session_event_search', 'session_event_trace', 'session_search', 'session_trace', 'skill', 'str_replace_editor', 'subagent', 'subagent', 'sync_bilingual_pair', 'terminal_close', 'terminal_list', 'terminal_open', 'terminal_read', 'terminal_send', 'terminal_signal', 'todo_write', 'update_goal', 'web_fetch', 'web_search', 'workflow', 'write'])
